...
import net.kathir.googlearchitecturewithobjectbox.viewmodel.ZooActivityViewModel;
...
public class ZooActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        findViewById(R.id.activity_zoo_fab).setOnClickListener(v-> Toast.makeText(this,"Not implemented",Toast.LENGTH_SHORT).show());
